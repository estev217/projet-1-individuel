...
<html lang="fr">
    ...
    <div class="section_home">
        <p class="subtitle">Un repas de qualité pour des clients de qualité</p>
        <div class="addings">
            <div class="feedbacks">
                
                <p class="feed"><em>Laura 34 ans</em> <br>
                    <b>"J'ai passé un agréable moment en famille.<br>
                    Service rapide et cuisine extra."</b>
                </p>
                <p class="feed"><em>Sébastien 45 ans</em> <br>
                    <b>"J'y déjeune souvent, la carte est très variée.<br>
                    Je conseille vivement."</b>
                </p>
                <p class="feed"><em>Sabrina 27 ans</em> <br>
                    <b>"Le restaurant est très bien situé.<br>
    ...
    <!-- START SECTION -->
        ...
        <section>
            <article id="intro" class="article_intro">
                <h3>Bistro Régent Bordeaux Bastide</h3>
                <p>
        ...
        <section>
            <article id="who" class="article_even">                
                ...
                <div class="div_txt">
                    <h3>Une firme qui a fait ses preuves</h3>
                    <p>
